...
type Log struct {
	...
	EnableFileLog bool                   `protobuf:"varint,2,opt,name=enable_file_log,json=enableFileLog,proto3" json:"enable_file_log,omitempty"`
...
func (x *Log) GetEnableFileLog() bool {
	if x != nil {
		return x.EnableFileLog
	}
	return false
}
...
type Server struct {
	...
	Etcd          *Server_Etcd           `protobuf:"bytes,3,opt,name=etcd,proto3" json:"etcd,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Server) GetEtcd() *Server_Etcd {
	if x != nil {
		return x.Etcd
	}
	return nil
...
type Server_Etcd struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Endpoints     []string               `protobuf:"bytes,1,rep,name=endpoints,proto3" json:"endpoints,omitempty"`
	Timeout       *durationpb.Duration   `protobuf:"bytes,2,opt,name=timeout,proto3" json:"timeout,omitempty"`
	Registry      *Server_Etcd_Registry  `protobuf:"bytes,3,opt,name=registry,proto3" json:"registry,omitempty"`
	Config        *Server_Etcd_Config    `protobuf:"bytes,4,opt,name=config,proto3" json:"config,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *Server_Etcd) Reset() {
	*x = Server_Etcd{}
...
func (x *Server_Etcd) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Server_Etcd) ProtoMessage() {}

func (x *Server_Etcd) ProtoReflect() protoreflect.Message {
	mi := &file_internal_conf_conf_proto_msgTypes[6]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Server_Etcd.ProtoReflect.Descriptor instead.
func (*Server_Etcd) Descriptor() ([]byte, []int) {
	return file_internal_conf_conf_proto_rawDescGZIP(), []int{2, 2}
}

func (x *Server_Etcd) GetEndpoints() []string {
	if x != nil {
		return x.Endpoints
	}
	return nil
...
func (x *Server_Etcd) GetTimeout() *durationpb.Duration {
	if x != nil {
		return x.Timeout
	}
	return nil
...
func (x *Server_Etcd) GetRegistry() *Server_Etcd_Registry {
	if x != nil {
		return x.Registry
	}
	return nil
...
func (x *Server_Etcd) GetConfig() *Server_Etcd_Config {
	if x != nil {
		return x.Config
	}
	return nil
...
type Server_Etcd_Registry struct {
	state         protoimpl.MessageState        `protogen:"open.v1"`
	Namespace     string                        `protobuf:"bytes,1,opt,name=namespace,proto3" json:"namespace,omitempty"`
	Ttl           *durationpb.Duration          `protobuf:"bytes,2,opt,name=ttl,proto3" json:"ttl,omitempty"`
	Service       *Server_Etcd_Registry_Service `protobuf:"bytes,3,opt,name=service,proto3" json:"service,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *Server_Etcd_Registry) Reset() {
	*x = Server_Etcd_Registry{}
	mi := &file_internal_conf_conf_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *Server_Etcd_Registry) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Server_Etcd_Registry) ProtoMessage() {}

func (x *Server_Etcd_Registry) ProtoReflect() protoreflect.Message {
	mi := &file_internal_conf_conf_proto_msgTypes[7]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Server_Etcd_Registry.ProtoReflect.Descriptor instead.
func (*Server_Etcd_Registry) Descriptor() ([]byte, []int) {
	return file_internal_conf_conf_proto_rawDescGZIP(), []int{2, 2, 0}
}

func (x *Server_Etcd_Registry) GetNamespace() string {
	if x != nil {
		return x.Namespace
	}
	return ""
...
func (x *Server_Etcd_Registry) GetTtl() *durationpb.Duration {
	if x != nil {
		return x.Ttl
	}
	return nil
...
func (x *Server_Etcd_Registry) GetService() *Server_Etcd_Registry_Service {
	if x != nil {
		return x.Service
	}
	return nil
...
type Server_Etcd_Config struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Namespace     string                 `protobuf:"bytes,1,opt,name=namespace,proto3" json:"namespace,omitempty"`
	WatchTimeout  *durationpb.Duration   `protobuf:"bytes,2,opt,name=watch_timeout,json=watchTimeout,proto3" json:"watch_timeout,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *Server_Etcd_Config) Reset() {
	*x = Server_Etcd_Config{}
	mi := &file_internal_conf_conf_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *Server_Etcd_Config) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Server_Etcd_Config) ProtoMessage() {}

func (x *Server_Etcd_Config) ProtoReflect() protoreflect.Message {
	mi := &file_internal_conf_conf_proto_msgTypes[8]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Server_Etcd_Config.ProtoReflect.Descriptor instead.
func (*Server_Etcd_Config) Descriptor() ([]byte, []int) {
	return file_internal_conf_conf_proto_rawDescGZIP(), []int{2, 2, 1}
}

func (x *Server_Etcd_Config) GetNamespace() string {
	if x != nil {
		return x.Namespace
	}
	return ""
...
func (x *Server_Etcd_Config) GetWatchTimeout() *durationpb.Duration {
	if x != nil {
...
type Server_Etcd_Registry_Service struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *Server_Etcd_Registry_Service) Reset() {
	*x = Server_Etcd_Registry_Service{}
	mi := &file_internal_conf_conf_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *Server_Etcd_Registry_Service) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Server_Etcd_Registry_Service) ProtoMessage() {}

func (x *Server_Etcd_Registry_Service) ProtoReflect() protoreflect.Message {
	mi := &file_internal_conf_conf_proto_msgTypes[9]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Server_Etcd_Registry_Service.ProtoReflect.Descriptor instead.
func (*Server_Etcd_Registry_Service) Descriptor() ([]byte, []int) {
	return file_internal_conf_conf_proto_rawDescGZIP(), []int{2, 2, 0, 0}
}

func (x *Server_Etcd_Registry_Service) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *Server_Etcd_Registry_Service) GetVersion() string {
	if x != nil {
		return x.Version
	}
	return ""
...
func (x *Server_Etcd_Registry_Service) GetMetadata() map[string]string {
	if x != nil {
		return x.Metadata
	}
	return nil
...
var file_internal_conf_conf_proto_rawDesc = []byte{
	...
	0x2e, 0x4c, 0x6f, 0x67, 0x52, 0x03, 0x6c, 0x6f, 0x67, 0x22, 0x60, 0x0a, 0x03, 0x4c, 0x6f, 0x67,
	0x12, 0x14, 0x0a, 0x05, 0x6c, 0x65, 0x76, 0x65, 0x6c, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x05, 0x6c, 0x65, 0x76, 0x65, 0x6c, 0x12, 0x26, 0x0a, 0x0f, 0x65, 0x6e, 0x61, 0x62, 0x6c, 0x65,
	0x5f, 0x66, 0x69, 0x6c, 0x65, 0x5f, 0x6c, 0x6f, 0x67, 0x18, 0x02, 0x20, 0x01, 0x28, 0x08, 0x52,
	0x0d, 0x65, 0x6e, 0x61, 0x62, 0x6c, 0x65, 0x46, 0x69, 0x6c, 0x65, 0x4c, 0x6f, 0x67, 0x12, 0x1b,
	0x0a, 0x09, 0x66, 0x69, 0x6c, 0x65, 0x5f, 0x70, 0x61, 0x74, 0x68, 0x18, 0x03, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x08, 0x66, 0x69, 0x6c, 0x65, 0x50, 0x61, 0x74, 0x68, 0x22, 0x86, 0x08, 0x0a, 0x06,
	...
	0x12, 0x2b, 0x0a, 0x04, 0x65, 0x74, 0x63, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x17,
	0x2e, 0x6b, 0x72, 0x61, 0x74, 0x6f, 0x73, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x53, 0x65, 0x72, 0x76,
	0x65, 0x72, 0x2e, 0x45, 0x74, 0x63, 0x64, 0x52, 0x04, 0x65, 0x74, 0x63, 0x64, 0x1a, 0x69, 0x0a,
	...
	0x6f, 0x75, 0x74, 0x1a, 0x9e, 0x05, 0x0a, 0x04, 0x45, 0x74, 0x63, 0x64, 0x12, 0x1c, 0x0a, 0x09,
	0x65, 0x6e, 0x64, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x09, 0x52,
	0x09, 0x65, 0x6e, 0x64, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x73, 0x12, 0x33, 0x0a, 0x07, 0x74, 0x69,
	...
	,
	...
	,
	...
	0x09, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x1a, 0x66, 0x0a, 0x06,
	0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x1c, 0x0a, 0x09, 0x6e, 0x61, 0x6d, 0x65, 0x73, 0x70,
	0x61, 0x63, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x6e, 0x61, 0x6d, 0x65, 0x73,
	0x70, 0x61, 0x63, 0x65, 0x12, 0x3e, 0x0a, 0x0d, 0x77, 0x61, 0x74, 0x63, 0x68, 0x5f, 0x74, 0x69,
	0x6d, 0x65, 0x6f, 0x75, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x67, 0x6f,
	0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x44, 0x75,
	0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x0c, 0x77, 0x61, 0x74, 0x63, 0x68, 0x54, 0x69, 0x6d,
	...
	0x65, 0x6f, 0x75, 0x74, 0x42, 0x1b, 0x5a, 0x19, 0x66, 0x61, 0x6b, 0x65, 0x72, 0x79, 0x2f, 0x69,
...
var file_internal_conf_conf_proto_goTypes = []any{
	...
	(*Server_Etcd)(nil),                  // 6: kratos.api.Server.Etcd
	(*Server_Etcd_Registry)(nil),         // 7: kratos.api.Server.Etcd.Registry
	(*Server_Etcd_Config)(nil),           // 8: kratos.api.Server.Etcd.Config
	(*Server_Etcd_Registry_Service)(nil), // 9: kratos.api.Server.Etcd.Registry.Service
	nil,                                  // 10: kratos.api.Server.Etcd.Registry.Service.MetadataEntry
...
var file_internal_conf_conf_proto_depIdxs = []int32{
	...
	6,  // 5: kratos.api.Server.etcd:type_name -> kratos.api.Server.Etcd
	...
	13, // 8: kratos.api.Server.HTTP.timeout:type_name -> google.protobuf.Duration
	13, // 9: kratos.api.Server.GRPC.timeout:type_name -> google.protobuf.Duration
	13, // 10: kratos.api.Server.Etcd.timeout:type_name -> google.protobuf.Duration
	7,  // 11: kratos.api.Server.Etcd.registry:type_name -> kratos.api.Server.Etcd.Registry
	8,  // 12: kratos.api.Server.Etcd.config:type_name -> kratos.api.Server.Etcd.Config
	13, // 13: kratos.api.Server.Etcd.Registry.ttl:type_name -> google.protobuf.Duration
	9,  // 14: kratos.api.Server.Etcd.Registry.service:type_name -> kratos.api.Server.Etcd.Registry.Service
	13, // 15: kratos.api.Server.Etcd.Config.watch_timeout:type_name -> google.protobuf.Duration
	10, // 16: kratos.api.Server.Etcd.Registry.Service.metadata:type_name -> kratos.api.Server.Etcd.Registry.Service.MetadataEntry
